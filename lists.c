...
/**
 * add_node - Inserts a node to the start of the list
 * @head: address of the pointer to the head node
 * @str: string field of the node
 * @num: node index employed for history
 *
...
/**
 * add_node_end - inserts a node to the end of the list
...
/**
 * free_list - frees all nodes within a list
